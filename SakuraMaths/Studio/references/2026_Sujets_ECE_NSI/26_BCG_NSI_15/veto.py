...
def normalisation_tel(tel):
    ...
    resultat = ""
    # On parcourt chaque caractère de la chaîne 'tel'
    ...
    # On renvoie le résultat final contenant uniquement les chiffres
    return resultat
...
# Pour tester, on réalise de simples affichages avec la fonction print()
# Test d'un numéro valide commençant par 06
print(validation_tel("0612345678"))  # Doit renvoyer True

# Test d'un numéro valide commençant par 07
print(validation_tel("0712345678"))  # Doit renvoyer True

# Test d'un numéro de longueur incorrecte (9 chiffres)
print(validation_tel("061234567"))  # Doit renvoyer False

# Test d'un numéro fixe (ne commence ni par 06 ni par 07, mais par 01)
print(validation_tel("0112345678"))  # Doit renvoyer False

# Test d'un numéro qui ne commence pas par 0 (le 1er caractère)
print(validation_tel("3612345678"))  # Doit renvoyer False
# -----------------------------------------------------------------------------
