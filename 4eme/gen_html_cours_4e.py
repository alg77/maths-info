...
sommaire = load_json("sommaire_4e.json")
competences = load_json("competences_4e.json")
capacites = load_json("capacites_4e.json")
...
<body>
    <header>
        ...
        <h1>Mes Cours de Maths - 4<sup>ème</sup></h1>
        <nav>
            <ul>
                <li><a href=\"../index.html\"><i class=\"fas fa-home\"></i> Accueil</a></li>
                <li><a href=\"../cours_4e.html\"><i class=\"fas fa-arrow-left\"></i> Retour aux Cours de 4<sup>ème</sup></a></li>
                <li class=\"dropdown\">
...
for theme, chapitres in sommaire.items():
    for chapitre in chapitres:
        ...
        competences_list = competences.get(fichier, competences.get("default", []))
        capacites_list = capacites.get(fichier, capacites.get("default", []))
