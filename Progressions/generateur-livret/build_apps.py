...
PANDA = "data:image/png;base64," + base64.b64encode(
    Path("/home/claude/assets/panda.png").read_bytes()).decode()
MATHVAR = "data:font/ttf;base64," + base64.b64encode(
    Path("/home/claude/fonts/KaTeX_Math-Italic.ttf").read_bytes()).decode()
...
OUT = Path("/mnt/user-data/outputs/generateur-livret")
